...
<form style="width: 90%; margin: 0 auto;" action="{{ url('/upload') }}" method="POST" enctype="multipart/form-data"><br>
	<h3 style="text-align: center;">Upload Assignment</h3>
...
@endif
 ...
 <div class="form-group">
    <label for="exampleInputEmail1">{{__('Upload Assignment')}}</label>
