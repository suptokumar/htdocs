...
<script>
  ...
  <div class="form-group">
    ...
    <input type="number" class="form-control" id="sd" value="{{$user->cancel_request}}" name="hours" aria-describedby="emailHelp">
    <input type="hidden" id="scrf" value="{{csrf_token()}}">
    <input type="hidden" id="id1" value="{{$user->id}}">
  </div>
...
<div class="pre_class">
  <h3>This month reports <button onclick="exportTableToExcel('tablon','table')" class="btn btn-success float-right">Download</button></h3>
