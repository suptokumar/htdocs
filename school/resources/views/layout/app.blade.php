...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('/public/css/admin.css?'.rand()) }}">
</head>
<body>
	<div class="header">
<header style="background: #364667" id="bg_no">
    ...
    <span style="font-size: 31px !important;font-weight: bold;text-shadow: 1px 1px 1px red;color: lightgreen;">Mohamed I.</span>
    </a>
  ...
  <nav>
    ...
    <ul class="admin-menu">
      ...
      <li class="manage_class">
        <a href="{{ asset('/admin/manage_class') }}">
          <svg>
            <use xlink:href="#pages"></use>
          </svg>
          <span>{{__('Manage Class')}}</span>
        </a>
      </li>
      <li class="teachers">
      ...
      <li class="waitings">
        <a href="{{ asset('/admin/waitings') }}">
          <svg>
            <use xlink:href="#users"></use>
          </svg>
          <span>{{__('Waitings')}}</span>
        </a>
      </li>
      <li class="students">
...
{{--       <li class="library">
    ...
    <ul class="admin-menu">
      ...
      <li class="manage_class">
        <a href="{{ asset('/teacher/manage_class') }}">
          <svg>
            <use xlink:href="#pages"></use>
          </svg>
          <span>{{__('Manage Class')}}</span>
...
{{--       <li class="teachers">
    ...
    <ul class="admin-menu">
      ...
      <li class="manage_class">
        <a href="{{ asset('/student/manage_class') }}">
          <svg>
            <use xlink:href="#pages"></use>
          </svg>
          <span>{{__('Manage Class')}}</span>
