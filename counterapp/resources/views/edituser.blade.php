...
<button type="button" class="btn btn-secondary ripple m-1" onclick="window.location='{{ url('/users') }}'">Back</button>
            	</div>
            </div>
            <div class="row">
            	<div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="card-title mb-3">{{$user->name}}'s Information</div>
...
@endif
                                ...
                                <div class="row">
                                    <div class="col-md-6 form-group mb-3">
                                        ...
                                        <input type="text" value="{{$user->name}}" class="form-control" id="name" name="name" placeholder="Enter your first name">
                                    </div>
