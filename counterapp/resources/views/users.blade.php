...
<button type="button" class="btn btn-secondary ripple m-1" onclick="window.location='{{ url('/createuser') }}'">Create Users</button>
            	</div>
    	...
    	<div class="col-3">
    		<select name="" id="type" class="form-control" onchange="load_users(1)">
...
function load_users(page){
	...
	.done(function(data) {
			...
			for (var i = 0; i < d[0].length; i++) {
				...
				body+= "<td>";
				body+=`   <button type="button" onclick='edituser(`+row['id']+`)' class="btn btn-success ">
                                                <i class="nav-icon i-Pen-2 "></i>
                                            </button>
                                                <button type="button" id="alert-confirm" onclick='deleteuser(`+row['id']+`,this)' class="btn btn-danger ">
                                                <i class="nav-icon i-Close-Window "></i>
                                            </button>`;
				body+= "</td>";
				body+= "</tr>";
...
{
	window.location='{{ url('/edituser') }}/'+id;
}
