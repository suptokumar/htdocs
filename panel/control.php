...
error_reporting(E_ALL);
    ...
    if ($numRows == 0)
    {
        $db->exec("INSERT INTO control(id,status,backgroundColor,version,host,hosts_name,hosts_url,hosts2_name,hosts2_url,hosts3_name,hosts3_url) VALUES('1','active','#400000','2.3','','','','','','','')");
    }
