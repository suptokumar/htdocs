...
<ul class="nav nav-tabs">
  <li class="nav-item">
    <a class="nav-link Services active btn btn btn-danger" href="javascript:void(0)" onclick="run_time('Service', this)">Services</a>
  </li>
  <li class="nav-item">
    <a class="nav-link xray active btn btn btn-success mx-1" href="javascript:void(0)" onclick="run_time('X-RAY', this)">X-RAY</a>
  </li>
  <li class="nav-item">
    <a class="nav-link ultra active btn btn btn-danger" href="javascript:void(0)" onclick="run_time('ULTRA', this)">ULTRA</a>
  </li>
  <li class="nav-item">
    <a class="nav-link ImageTests btn btn-primary mx-1" href="javascript:void(0)" onclick="run_time('ECG', this)">ECG</a>
  </li>
  <li class="nav-item">
...
<div class="col-sm-5">
  <form action="{{ url('/testsadd') }}" method="POST">
    ...
    <div class="row">
      ...
      <div class="col-sm-5">
    <input type="text" name="discount" autocomplete="off" onkeyup="sum_test2(this.value);" class="input form-control" value="0">
      </div>
    </div>
    <div class="row">
      <div class="col-sm-7">
      ...
      <div class="col-sm-5">
    <input type="text" name="discount" autocomplete="off" onkeyup="sum_test();" id="discount" class="input form-control" value="0">
      </div>
    </div>
    <div class="row">
      <div class="col-sm-7">
      ...
      <div class="col-sm-5">
    <input type="text" name="total" id="total" autocomplete="off" onkeyup="due_check();" readonly class="input form-control" value="0">
      </div>
    </div>
    <div class="row">
      <div class="col-sm-7">
      ...
      <div class="col-sm-5">
    <input type="text" name="paid" id="paid" autocomplete="off" onkeyup="due_check();" class="input form-control" value="0">
      </div>
    </div>
    <div class="row">
      <div class="col-sm-7">
    ...
    <div class="row">
      ...
      <div class="col-sm-5">
        <label for="confirm">
    <input type="checkbox" name="confirm" id="confirm" required="" class="input"> Confirm?
        </label><br>
