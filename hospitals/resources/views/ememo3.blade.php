						...
						<table class="table">
							<thead>
								...
								@php
									...
									if($test->date!=''){
										$day = floor((strtotime($test->updated_at)-strtotime($test->date))/86400)+1;
...
$gd = $rate[$key];
								...
								<tr>
									<td colspan="2" style="font-weight: bold;text-shadow: 1px 1px 1px #ddd;">Test Discount</td>
								...
								<tr>
									<td colspan="2" style="font-weight: bold;text-shadow: 1px 1px 1px #ddd;">Total Discount</td>
