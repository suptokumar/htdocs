...
<div class="col-sm-5">
  <form action="{{ url('/admission/testsadd') }}" method="POST">
    @csrf
    <table class="table">
    <thead>
      <tr>
...
<div class="details">
  ...
  <div class="box yellow">
    ...
    <h2>Print Memo</h2>
    <h2 id="t_4"><a href="{{ url('/memo/whole/'.$user->id) }}" class="btn btn-danger">Print</a></h2>
  </div>
</div>
<div class="rk">
Search <input type="search" id="snod410" autocomplete="off" onkeyup="adtests(1)" style="padding: 10px; border: 1px solid #ccc; outline: none;" placeholder="Search">
...
<script>
    $(document).ready(function() {
        adtests(1);
        $.ajax({
            url: '{{ url('/admission/load_userdetails') }}',
            type: 'POST',
