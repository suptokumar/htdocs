...
{{--     <button class="btn btn-info" style="float: left; margin: 5px" onclick="window.location='{{ url('/admin/service') }}'">Add Tests</button> 
...
@endif
@csrf
@if (Auth::user()->role=="Admin" OR isset($doctor))
	
  <div class="form-group row">
    <label for="inputEmail3" class="col-sm-2 col-form-label">Acount type</label>
    <div class="col-sm-10">
      <select name="role" class="form-control" id="role">
      <option value="Admin" {{isset($doctor)?($doctor->role=='Admin'?'selected':''):''}}>Admin</option>
      <option value="Manager" {{isset($doctor)?($doctor->role=='Manager'?'selected':''):''}}>Manager</option>
      <option value="Reciptionist" {{isset($doctor)?($doctor->role=='Reciptionist'?'selected':''):''}}>Reciptionist</option>
      </select>
    </div>
    </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" name="name" autofocus="" autocomplete="off" class="form-control" id="name" value="{{isset($doctor)?$doctor->name:''}}" placeholder="">
    </div>
    </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="email" name="email" autocomplete="off" class="form-control" id="email" value="{{isset($doctor)?$doctor->email:''}}">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" name="phone" autocomplete="off" class="form-control" id="phone" value="{{isset($doctor)?$doctor->phone:''}}">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" name="address" autocomplete="off" class="form-control" id="address" value="{{isset($doctor)?$doctor->address:''}}">
...
Search <input type="search" id="snod410" autocomplete="off" onkeyup="accounts(1)" style="padding: 10px; border: 1px solid #ccc; outline: none;" placeholder="Search">
</div>
<div class="dk">
