...
@csrf
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
    <label for="asdfs">
      <input type="checkbox" id="asdfs" step=".001" name="fullpayment" > <span>Make Full Payment</span></label>
    </div>
  </div>
...
Search <input type="search" id="snod410" autocomplete="off" onkeyup="prev_details(1)" style="padding: 10px; border: 1px solid #ccc; outline: none;" placeholder="Search">
</div>
