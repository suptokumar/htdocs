...
$layout = $row['layout'];
$output.='{"icons": {"live": "'.$live.'","logo": "'.$logo.'","banner": "'.$banner.'","banner2": "'.$banner2.'","banner3": "'.$banner3.'","banner4": "'.$banner4.'","banner5": "'.$banner5.'","catchup": "'.$catchup.'","movie": "'.$movie.'","series": "'.$series.'","settings": "'.$settings.'","background": "'.$background.'","netflix": "'.$netflix.'","youtube": "'.$youtube.'","playstore": "'.$playstore.'","settings2": "'.$settings2.'", "appdrawer": "'.$appdrawer.'", "tvlive": "'.$tvlive.'", "account": "'.$account.'", "catchup2": "'.$catchup2.'", "parental": "'.$parental.'", "store": "'.$store.'", "record": "'.$record.'", "options": "'.$options.'", "multiscreen": "'.$multiscreen.'", "vpn": "'.$vpn.'", "zipcode": "'.$zipcode.'", "liveview": "'.$liveview.'", "speedtest": "'.$speedtest.'", "layout": "'.$layout.'"}}';
echo $output;
?>