...
$account = $row['account'];
$catchup2 = $row['catchup2'];
$parental = $row['parental'];
$store = $row['store'];
$record = $row['record'];
$options = $row['options'];
$multiscreen = $row['multiscreen'];
$vpn = $row['vpn'];
$zipcode = $row['zipcode'];
$liveview = $row['liveview'];
$speedtest = $row['speedtest'];
$layout = $row['layout'];
$status = "active";
...
//echo $output;
$output ='{ "status": "'.$status.'", "backgroundColor": "'.$backgroundColor.'", "version": "'.$version.'", "apk": "'.$lurl.'/addons.php/master.apk", "host": "'.$host.'", "rss": "'.$lurl.'/rss.php", "addons": "'.$lurl.'/addons.php", "storeConfiig": "'.$lurl.'/store.php", "icons": { "live": "'.$live.'", "logo": "'.$logo.'", "banner": "'.$banner.'", "banner_url": "", "banner2": "'.$banner2.'", "banner_url2": "", "banner3": "'.$banner3.'", "banner_url3": "", "banner4": "'.$banner4.'", "banner_url4": "", "banner5": "'.$banner5.'", "banner_url": "", "catchup": "'.$catchup.'", "movie": "'.$movie.'", "series": "'.$series.'", "settings": "'.$settings.'", "background": "'.$background.'", "netflix": "'.$netflix.'", "youtube": "'.$youtube.'", "playstore": "'.$playstore.'", "settings2": "'.$settings2.'", "appdrawer": "'.$appdrawer.'", "tvlive": "'.$live.'", "account": "'.$account.'", "catchup2": "'.$catchup2.'", "parental": "'.$parental.'", "store": "'.$store.'", "record": "'.$record.'", "options": "'.$options.'", "multiscreen": "'.$multiscreen.'", "vpn": "'.$vpn.'", "zipcode": "'.$zipcode.'", "liveview": "'.$liveview.'", "speedtest": "'.$speedtest.'", "layout": "'.$layout.'" }, "apps": [], "host_urls": [ { "name": "'.$hosts_name.'", "url": "'.$hosts_url.'" }, { "name": "'.$hosts2_name.'", "url": "'.$hosts2_url.'" }, { "name": "'.$hosts3_name.'", "url": "'.$hosts3_url.'" } ] }';
