...
<form action="{{ url('/admin/createapi/addplan') }}" method="POST" enctype="multipart/form-data">
...
@endif
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" name="name" id="name" required="" placeholder="eg: Gold">
    </div>
    <div class="form-group col-md-6">
      <label for="min_withdraw_amount">Minimum Withdrawal Amount <span class="red">*</span></label>
      <input type="number" class="form-control" name="min_withdraw_amount" for="min_withdraw_amount" placeholder="eg: 10">
    </div>
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input type="number" class="form-control" name="max_withdraw_amount" required for="max_withdraw_amount" placeholder="eg: 10">
<br>
      <label for="max_withdraw_perday">Max Withdrawal Per Day <span class="red">*</span></label>
      <input type="number" class="form-control" name="max_withdraw_perday" required for="max_withdraw_perday" placeholder="eg: 10">
    <br>
      <label for="max_withdraw_month">Max Withdrawal Per Month <span class="red">*</span></label>
      <input type="number" class="form-control" name="max_withdraw_month" required for="max_withdraw_month" placeholder="eg: 10">
    
    </div>
    
    <div class="form-group col-md-6">
    	<label for="min_refil_amount">Minimum Refil Amount <span class="red">*</span></label>
      <input type="number" class="form-control" name="min_refil_amount" required for="min_refil_amount" placeholder="eg: 10">
    <br><label for="min_maintaining_amount">Minimum Maintaining Amount <span class="red">*</span></label>
      <input type="number" class="form-control" name="min_maintaining_amount" required for="min_maintaining_amount" placeholder="eg: 10">
    <br>
