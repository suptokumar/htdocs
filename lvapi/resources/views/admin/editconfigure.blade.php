...
@endif
  ...
  <div class="form-row">
    <div class="form-group col-md-12">
      ...
      <input type="text" class="form-control" name="name" id="name" required="" value="{{$configure->text}}" placeholder="eg: Cricket">
    </div>
    
    <div class="form-group col-md-12">
      <label for="icon">Configure Logo<br>
      <img src="{{ url('/public/') }}/{{$configure->logo}}" id="blah" alt="Default Image" style="width: 150px; height: 135px; border-radius: 10px;"></label>
