...
<header style="overflow: hidden;">
	<div class="row">
		...
		<div class="col-4">
	<a href="{{ url('/admin/createwithdrawal') }}" class="btn btn-info float-right">Create Wallet Withdrawal</a>
  <a href="{{ url('/admin/withdralid') }}" class="btn btn-warning float-right">ID withdrawal</a>
    ...
    .done(function(data) {
     var d = JSON.parse(data);
      ...
      for (var i = 0; i < d[0].length; i++) {
        ...
        <h5><pre style='color: white'>`+row['info']+`</pre></h5>
        </div>
        <div class="col-2 center" style='padding-top: 15px;'>
        <h5>ID: `+row['idm']+`</h5>
