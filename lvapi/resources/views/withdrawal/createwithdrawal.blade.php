...
<section class="gateway_view">
  <form action="{{ url('/admin/createapi/addwithdrawalrequest') }}" method="POST" enctype="multipart/form-data">
...
{{--    <div class="form-group col-md-6">
 ...
 --}}
  ...
  <div class="cpnel">
   <label for="info">Info <span class="red">*</span></label>
    <textarea id="info" name="info" placeholder="I am making this Withdraw" class="form-control"></textarea>
  </div>
  <br>
  <div style="text-align: center;">
  <button type="submit" class="btn btn-primary">Create Withdraw Request</button>
  </div>
</form>
</section>
</article>
