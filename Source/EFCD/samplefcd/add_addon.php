<?php
    ...
    {
        $db->exec("INSERT INTO addons(added_date,description,icon,app_id,name,url,version,version_code) VALUES('1607627132','".$_POST['description']."','".$_POST['icon']."','".$_POST['app_id']."','".$_POST['name']."','".$_POST['url']."','".$_POST['version']."','".$_POST['version_code']."')");
            ...
            <div class="card-body">
                <div class="card bg-primary text-white">
                    <div class="card-header card-header-warning">
                        <center>
                            <h2><i class="icon icon-puzzle-piece"></i> Add Addon Details</h2>
                        </center>
                    </div>
                    ...
                    <div class="card-body">
                            <form method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="icon" name="icon" value="<?php echo $lurl . '/img/' ?>" type="text"/>
                                </div>             

                                <div class="form-group">
                                    <label class="form-label " for="url" >URL</label>
                                    <input class="form-control" id="url" name="url" value="<?php echo $lurl . '/apk/' ?>" type="text"/>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <center>
                                        <button class="btn btn-info " name="addons" type="submit">
