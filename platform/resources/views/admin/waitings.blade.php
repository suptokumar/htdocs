...
@csrf
  ...
  <div class="form-group col-sm-4">
    ...
    <input type="date" class="form-control" id="time_to_contact" required="" name="time_to_contact" aria-describedby="emailHelp"     value="{{ old("time_to_contact") }}" placeholder="Time to contact">
  </div>
  <div class="form-group col-sm-4">
...
<div class="form-group">
    ...
    <textarea style="height: 200px" class="form-control" id="contact" required="" name="contact" aria-describedby="emailHelp"  placeholder="Contact">
    * Email  :
    * Mobile :
    * FB     :
    *  Other :
