...
@csrf
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="rate" required="" name="rate" aria-describedby="emailHelp" value="{{ $client->rate }}" placeholder="Enter Hourly Rate">
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="invoice_number" required="" name="invoice_number" aria-describedby="emailHelp" value="{{ $client->invoice_number }}" placeholder="Enter Hourly Rate">
  </div>
