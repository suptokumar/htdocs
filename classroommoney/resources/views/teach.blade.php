...
<div class="topnav" id="myTopnav">
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content">
      ...
      <a href="{{ url('/student/teach') }}" class="active">My Teachers</a>
...
<script>
  ...
  function veri_teachers(page){
    $.ajax({
      url: '{{ url('/student/myteacherlist') }}',
      type: 'POST',
      data: {page: page, search: $("#snod410").val(), _token:'{{csrf_token()}}'},
    })
    .done(function(data) {
     var d = JSON.parse(data);
      var body = '<table class="table"> <thead class="thead-light"> <tr> <th scope="col">#</th> <th scope="col">Name</th> <th scope="col">Email</th><th scope="col">School</th><th scope="col">Options</th> </tr> </thead> <tbody>';
