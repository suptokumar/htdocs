...
<script>
	...
	function userlist(page){
		var order = $("#order").val();
    $.ajax({
      url: '{{ url('/admin/1sdf2g14e') }}',
      type: 'POST',
      data: {page: page,order: order, search: $("#snod410").val(), _token:'{{csrf_token()}}'},
    })
    .done(function(data) {
     var d = JSON.parse(data);
      var body = '<table class="table"> <thead class="thead-light"> <tr> <th scope="col">#</th> <th scope="col">Student Name</th> <th scope="col">Email</th><th scope="col">Phone</th><th scope="col">Book Name</th><th scope="col">Book Label</th><th scope="col">Exam Grade</th><th scope="col">Score</th><th scope="col">Earning</th> </tr> </thead> <tbody>';
